...
struct xlnx_sdi_display_config {
	...
	u8 st352_byt2[2];
	u8 st352_byt1[6];
	u8 sdi_mod_val; // uhdsdi-txss sdi_tx_ctrl[6:4]
};
#define TX_MODE_HD 0
#define TX_MODE_SD 1
#define TX_MODE_3G 2
#define TX_MODE_6G 4
#define TX_MODE_12G 5
...
static const struct xlnx_sdi_display_config xlnx_sdi_modes[] = {
	...
	{{ DRM_MODE("720x486i", DRM_MODE_TYPE_DRIVER, 13500, 720, 739,
		   ...
		   {0x81, 0x81, 0x81, 0x81, 0x81, 0x81}, TX_MODE_SD },
	/* SD: 720x576i@50Hz */
	...
	{{ DRM_MODE("1280x720", DRM_MODE_TYPE_DRIVER, 74250, 1280, 2250,
		   ...
		   {0x84, 0x84, 0x88, 0x84, 0x84, 0x84}, TX_MODE_HD },
	/* HD: 1280x720@24Hz */
	{{ DRM_MODE("1280x720", DRM_MODE_TYPE_DRIVER, 74250, 1280, 2250,
	...
	{{ DRM_MODE("1920x1080", DRM_MODE_TYPE_DRIVER, 74250, 1920, 2558,
		   ...
		   {0x85, 0x85, 0x89, 0x8A, 0xC1, 0xC1}, TX_MODE_HD },
	/* HD: 1920x1080@25Hz */
	...
	{{ DRM_MODE("1920x1080", DRM_MODE_TYPE_DRIVER, 148500, 1920, 2558,
		   ...
		   {0x85, 0x85, 0x89, 0x8A, 0xC1, 0xC1}, TX_MODE_3G },
	/* 3G: 1920x1080@50Hz */
	...
	{{ DRM_MODE("3840x2160", DRM_MODE_TYPE_DRIVER, 296704, 3840, 4016,
		   ...
		   {0x98, 0x98, 0x97, 0x98, 0xC0, 0xCE}, TX_MODE_6G },
	/* 6G: 3840x2160@30Hz */
	...
	{{ DRM_MODE("3840x2160", DRM_MODE_TYPE_DRIVER, 594000, 3840, 5116,
		   ...
		   {0x98, 0x98, 0x97, 0x98, 0xC0, 0xCE}, TX_MODE_12G },
	/* 12G: 3840x2160@50Hz */
	...
	{{ DRM_MODE("1920x1080", DRM_MODE_TYPE_DRIVER, 297000, 1920, 2448,
		   ...
		   {0x85, 0x85, 0x89, 0x8A, 0xC1, 0xCF}, TX_MODE_6G },
